package com.manager.appbanhang.activity.Fragment;
...
import com.manager.appbanhang.activity.JoinActivity;
import com.manager.appbanhang.activity.MeetingActivity;
import com.manager.appbanhang.adapter.SpeakerAdapter;
...
public class SpeakerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (meeting != null) {
            tvMeetingId.setText("Id : " + meeting.getMeetingId());
            setActionListeners();
    ...
    private final MeetingEventListener meetingEventListener = new MeetingEventListener() {
        ...
        public void onHlsStateChanged(JSONObject HlsState) {
            if (HlsState.has("status")) {
                try {
                    tvHlsState.setText("STATUS : " + HlsState.getString("status"));
                    if (HlsState.getString("status").equals("STARTED")) {
                        hlsEnabled=true;
                        btnHls.setText("Stop HLS");
                    }
                    if (HlsState.getString("status").equals("STOPPED")) {
                        hlsEnabled = false;
